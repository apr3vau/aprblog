  ...
  (unless (gir:repository-get-search-path)
    (if (ignore-errors (truename "../lib/girepository-1.0/"))
        ...
        (progn (log4cl:log-error "Cannot find typelib! Exit...")
               (return-from main))))
  (setq gtk:*ns* (gir:require-namespace "Gtk")
        adw:*ns* (gir:require-namespace "Adw"))
...
;; (generate)
;; (aprblog:main)
;; (sb-ext:save-lisp-and-die "aprblog" :toplevel 'aprblog:main :executable t :compression t)
